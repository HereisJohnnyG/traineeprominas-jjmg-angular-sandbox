...
const apiUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api;
...
let CourseAddComponent = class CourseAddComponent {
    constructor(router, apiTeacher, api, formBuilder) {
        this.router = router;
    ...
    getTeacher() {
        this.apiTeacher.getTeachers()
            ...
            this.teacher = this.dataSource.map((item) => {
                const teacher = new src_model_teacher__WEBPACK_IMPORTED_MODULE_6__["Teacher"]();
                teacher.id = item.id;
...
let CourseUpdateComponent = class CourseUpdateComponent {
    constructor(router, route, apiTeacher, api, formBuilder) {
        this.router = router;
        this.route = route;
        this.apiTeacher = apiTeacher;
        this.api = api;
    ...
    getTeacher() {
        this.apiTeacher.getTeachers()
            ...
            this.dataSource = res;
            this.teacher = this.dataSource.map((item) => {
                const teacher = new src_model_teacher__WEBPACK_IMPORTED_MODULE_5__["Teacher"]();
                teacher.id = item.id;
                teacher.name = item.name;
                teacher.lastName = item.lastName;
                teacher.phd = item.phd;
...
let CourseService = class CourseService {
    ...
    getCourses() {
        return this.http.get(`${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}course`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(courses => console.log('leu os cursos')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCourses', [])));
    }
    getCourse(id) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}JSON/course/${id}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`leu o usuário id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getCourse id=${id}`)));
    }
    postCourse(course) {
        return this.http.post(`${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}course`, course, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((course1) => console.log(`adicionou o curso com w/ id=${course1.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('postCourse')));
    }
    putCourse(id, course) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}course/${id}`;
        return this.http.put(url, course, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`atualiza o usuário com id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateCourse')));
    }
    deleteCourse(id) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}Course/${id}`;
        return this.http.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`remove o usuário com id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteCourse')));
    }
...
let CourseComponent = class CourseComponent {
    ...
    ngOnInit() {
        this.api.getCourses()
            .subscribe(res => {
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](res);
...
let StudentAddComponent = class StudentAddComponent {
    constructor(router, apiCourse, api, formBuilder) {
        this.router = router;
    ...
    getCourse() {
        this.apiCourse.getCourses()
            ...
            this.course = this.dataSource.map((item) => {
                const course = new src_model_course__WEBPACK_IMPORTED_MODULE_6__["Course"]();
                course.id = item.id;
...
let StudentUpdateComponent = class StudentUpdateComponent {
    constructor(router, route, apiCourse, api, formBuilder) {
        this.router = router;
        this.route = route;
        this.apiCourse = apiCourse;
        this.api = api;
...
let StudentService = class StudentService {
    ...
    getStudents() {
        return this.http.get(`${_app_api__WEBPACK_IMPORTED_MODULE_3__["apiUrl"]}student`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(students => console.log('leu os cursos')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('getStudents', [])));
    }
    getStudent(id) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_3__["apiUrl"]}JSON/student/${id}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(_ => console.log(`leu o usuário id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError(`getStudent id=${id}`)));
    }
    postStudent(student) {
        return this.http.post(`${_app_api__WEBPACK_IMPORTED_MODULE_3__["apiUrl"]}student`, student, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])((student1) => console.log(`adicionou o curso com w/ id=${student1.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('postStudent')));
    }
    putStudent(id, student) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_3__["apiUrl"]}student/${id}`;
        return this.http.put(url, student, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(_ => console.log(`atualiza o usuário com id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('updateStudent')));
    }
    deleteStudent(id) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_3__["apiUrl"]}Student/${id}`;
        return this.http.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(_ => console.log(`remove o usuário com id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('deleteStudent')));
    }
    handleError(operation = 'operation', result) {
        return (error) => {
            console.error(error);
...
let TeacherService = class TeacherService {
    ...
    getTeachers() {
        return this.http.get(`${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}JSON/teacher`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(teachers => console.log('leu os usuários')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getTeachers', [])));
    }
    getTeacher(id) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}JSON/teacher/${id}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`leu o usuário id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getTeacher id=${id}`)));
    }
    postTeacher(teacher) {
        return this.http.post(`${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}teacher`, teacher, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((teacher1) => console.log(`adicionou o usuário com w/ id=${teacher1.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('postTeacher')));
    }
    putTeacher(id, teacher) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}teacher/${id}`;
        return this.http.put(url, teacher, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`atualiza o usuário com id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateTeacher')));
    }
    deleteTeacher(id) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}Teacher/${id}`;
        return this.http.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`remove o usuário com id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteTeacher')));
    }
    handleError(operation = 'operation', result) {
        return (error) => {
            console.error(error);
...
let UserService = class UserService {
    ...
    getUsers() {
        return this.http.get(`${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}JSON/user`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(users => console.log('leu os usuários')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getUsers', [])));
    }
    getUser(id) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}JSON/user/${id}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`leu o usuário id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getUser id=${id}`)));
    }
    postUser(user) {
        return this.http.post(`${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}user`, user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((user1) => console.log(`adicionou o usuário com w/ id=${user1.id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('postUser')));
    }
    putUser(id, user) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}user/${id}`;
        return this.http.put(url, user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`atualiza o usuário com id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateUser')));
    }
    deleteUser(id) {
        const url = `${_app_api__WEBPACK_IMPORTED_MODULE_5__["apiUrl"]}user/${id}`;
